...
Continent.find_or_create_by(map_id: io.id, name: "Mashriq", type: "Lava", bonus: 1, color: "#bfbfbf")
Continent.find_or_create_by(map_id: io.id, name: "Caprica", type: "Lava", bonus: 1, color: "#fd9415")
Continent.find_or_create_by(map_id: io.id, name: "Soter", type: "Lava", bonus: 1, color: "#2e2e2e")
Continent.find_or_create_by(map_id: io.id, name: "Khell", type: "Lava", bonus: 3, color: "#6bc2cb")
Continent.find_or_create_by(map_id: io.id, name: "Nuraghe", type: "Lava", bonus: 1, color: "#e10005")
Continent.find_or_create_by(map_id: io.id, name: "Magreb", type: "Lava", bonus: 3, color: "#4c0fb5")
