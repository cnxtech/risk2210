module Fixtures
  class Facebook
    ...
    def self.chick
      {"provider"=>"facebook", "uid"=>"1372100291", "info"=>{"nickname"=>"samantha.diaz.566", "email"=>"shadow01wolf@gmail.com", "name"=>"Samantha Diaz", "first_name"=>"Samantha", "last_name"=>"Diaz", "image"=>"http://graph.facebook.com/1372100291/picture?type=square", "description"=>"I'm a loving person. I get really nervous around some guys, especially if I like them. I try not to show that though. XD;", "urls"=>{"Facebook"=>"http://www.facebook.com/samantha.diaz.566"}, "verified"=>true}, "credentials"=>{"token"=>"AAADMjLRob70BAMSyZCdnbfDlxoBOER56IIHp2cMQYS5NPziDuIy4EWlQinNc7ZBSAfRjJYxWLqbLIzbZAXOcRZCS7z1f3ddNSWzryUYhKAZDZD", "expires_at"=>1353654498, "expires"=>true}, "extra"=>{"raw_info"=>{"id"=>"1372100291", "name"=>"Samantha Diaz", "first_name"=>"Samantha", "last_name"=>"Diaz", "link"=>"http://www.facebook.com/samantha.diaz.566", "username"=>"samantha.diaz.566", "about"=>"I'm Sam. I like to draw, and I like to play the flute. =w= I love a treasured few, and have no enemies as of yet...", "bio"=>"I'm a loving person. I get really nervous around some guys, especially if I like them. I try not to show that though. XD;", "quotes"=>"\"We shall prevail.\"\n\"I can and I will.\"\n\"Sometimes things are harder than they seem.\"", "gender"=>"female", "email"=>"shadow01wolf@gmail.com", "timezone"=>-7, "locale"=>"en_US", "verified"=>true, "updated_time"=>"2012-06-12T12:49:57+0000"}}}
    end
